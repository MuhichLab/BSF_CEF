function [G_soln,G_ex,G_end_mem] = CEF_for_plots_no_dft(expansion)
    %Constants
    ...
    if expansion == 1
        ...
        G_soln = simplify(expand(subs(G_soln,[Ho1 Ho2],[(gDiffA1) (gDiffA2)])));
        ...
        G_end_mem = simplify(expand(subs(G_end_only,[Ho1 Ho2],[(gDiffA1) (gDiffA2)])));

        G_end_diff = simplify(expand(diff(G_end_mem,y)));
    ...
    elseif expansion == 2
        ...
        G_soln = subs(G_soln,[Ho1 Ho2],[(gDiffA1) (gDiffA2)]);
    ...
    elseif expansion == 3
        ...
        G_end_mem = subs(G_end_only,[Ho1 Ho2],[(gDiffA1) (gDiffA2)]);
