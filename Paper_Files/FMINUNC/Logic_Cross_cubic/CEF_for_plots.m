function [G_soln,G_ex,G_end_mem] = CEF_for_plots(expansion)
    %end point values for pahse shift 
    g1 = -550.31/8;  %SrFeO3   (Fe 4+)
    g2 = -683.90/8;  %BaFeO3   (Fe 4+)
    g3 = -541.71/8;  %SrFeO2.5 (Fe 3+)
    g4 = -678.42/8;  %BaFeO2.5 (Fe 3+)
    ...
    if expansion == 1
        ...
        G_dft = subs(G_dft,[Ho1 Ho2 G3 G4],[(g3 - g1 + gDiffA1) (g4 - g2 + gDiffA2) g3 g4]);
        ...
        G_end_mem = subs(G_end_only,[Ho1 Ho2 G3 G4],[(g3 - g1 + gDiffA1) (g4 - g2 + gDiffA2) g3 g4]);

        G_end_diff = diff(sym(G_end_mem),y);
        ...
        G_end_dft = subs(G_end_only,[Ho1 Ho2 G3 G4],[(g3 - g1 + gDiffA1) (g4 - g2 + gDiffA2) g3 g4]);
    ...
    elseif expansion == 2
        ...
        G_soln = subs(G_soln,[Ho1 Ho2 G3 G4],[(g3 - g1 + gDiffA1) (g4 - g2 + gDiffA2) g3 g4]);
    ...
    elseif expansion == 3
        ...
        G_end_mem = subs(G_end_only,[Ho1 Ho2],[(g3 - g1 + gDiffA1) (g4 - g2 + gDiffA2)]);
